-- Drop and recreate the can_create_campaign function to ensure trial users can create 1 campaign of each type
DROP FUNCTION IF EXISTS public.can_create_campaign(uuid, text);
